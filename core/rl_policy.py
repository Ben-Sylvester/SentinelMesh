...
class RLPolicy:
    ...
    def normalize_reward(self, state, reward: float) -> float:
    ...
    def select(self, state, actions: list):
    ...
    def update(self, state, action, reward: float, next_state) -> None:
        ...
        # B-11 fix: epsilon decay removed from here.
        # Router._update() is the single owner of epsilon decay schedule,
        # preventing the double-decay that caused 2× faster exploration collapse.
